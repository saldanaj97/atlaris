...
- [x] Finding 9: Auth screens are clean but generic.
  ...
  - [x] Wrap Clerk auth components in a product-styled container (replace generic centering).
  - [x] Use Clerk appearance options only where they improve consistency without fighting the embedded component.
