---
description: Guidelines for auditing and writing tests to ensure robust testable architecture.
applyTo: tests/**/*
---
...
if (process.env.DATABASE_URL?.includes('prod') || process.env.DATABASE_URL?.includes('neon.tech')) {
