...
- Same-repository deploy-impacting PRs create remote-built Preview deployments; PR-controlled build code never runs with the Vercel token in GitHub. Forks and Dependabot PRs never receive Vercel secrets.
