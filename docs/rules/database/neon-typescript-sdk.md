...
); // Example: "postgresql://neondb_owner:xxxx@ep-muddy-brook-aevd5iky.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require"
```
...
```typescript
await apiClient.suspendProjectEndpoint(
  'your-project-id',
  'ep-your-endpoint-id'
);
```
...
```typescript
await apiClient.restartProjectEndpoint(
  'your-project-id',
  'ep-your-endpoint-id'
);
```
