...
| Settings          | `settings/components/SettingsLedgerPage.tsx`; notification form                                                            | Independent owner/saving boundaries; override preserves choices; no global Save across vendor flows.                            |
