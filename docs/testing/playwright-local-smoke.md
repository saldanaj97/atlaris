...
4. If the smoke contract, helpers, or runner change, update this document in the same change. Do not write smoke notes to `.agents/recaps/`, `.agents/handoffs/`, `prds/`, or `.cursor/plans/`.
