...
Official Docs Link: [https://clerk.com/docs/cli](https://clerk.com/docs/cli)

The Clerk CLI is a command-line tool for you and your agents to set up and manage [Clerk]([https://clerk.com/](https://clerk.com/)) authentication directly from the terminal. It supports 10+ frameworks.
...
$ curl -fsSL [https://clerk.com/install](https://clerk.com/install) | bash
...
- **Connect AI clients to Clerk's MCP server** — `clerk mcp install` registers [Clerk's MCP server]([https://clerk.com/docs/guides/ai/mcp/clerk-mcp-server.md](https://clerk.com/docs/guides/ai/mcp/clerk-mcp-server.md)) in the AI clients detected on your machine, such as Claude Code, Cursor, and VS Code. `clerk mcp list` shows what's registered, and `clerk mcp uninstall` removes it.
...
- **Open the Dashboard** — `clerk open` launches the [Clerk Dashboard]([https://dashboard.clerk.com](https://dashboard.clerk.com)) in your browser from the terminal.
...
- **Clerk Skills** — Accept the optional prompt during `clerk init` (which installs Clerk's agent skills, including `clerk-cli`), or run `npx skills add clerk/skills` anytime, to install [Clerk Skills]([https://clerk.com/docs/guides/ai/skills.md](https://clerk.com/docs/guides/ai/skills.md)) — giving your AI agent deeper knowledge about Clerk's SDKs and patterns.
...
Yes. The CLI is open source and available on [GitHub]([https://github.com/clerk/cli](https://github.com/clerk/cli)).

### How do I report a bug?

Open an issue on the [GitHub repo]([https://github.com/clerk/cli/issues](https://github.com/clerk/cli/issues)) or [contact support]([https://clerk.com/contact/support](https://clerk.com/contact/support)).

### How do I request a feature?

Submit feature requests on Clerk's [public roadmap]([https://feedback.clerk.com/roadmap](https://feedback.clerk.com/roadmap)).