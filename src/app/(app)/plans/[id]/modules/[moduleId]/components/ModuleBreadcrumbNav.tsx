    ...
    <nav className='mb-6'>
      <ol className='flex items-center gap-1 text-sm'>
        <li>
          <Link
            href={`/plans/${planId}`}
            className='inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-primary'
          >
