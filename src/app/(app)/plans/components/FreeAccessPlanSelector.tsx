            ...
            {candidates.map((candidate) => (
              ...
              >
                <input
                  ...
                  className='mt-[4px] size-[20px] shrink-0 accent-action-primary outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background'
                />
