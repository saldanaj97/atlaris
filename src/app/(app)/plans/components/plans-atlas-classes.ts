...
export const ATLAS_TAB_CLASS =
  ...
  'data-[state=active]:rounded-2xl data-[state=active]:border data-[state=active]:border-primary/35 data-[state=active]:bg-card/75 data-[state=active]:shadow-md data-[state=active]:backdrop-blur-xl dark:data-[state=active]:border-primary/45 dark:data-[state=active]:bg-card/55 data-[state=active]:text-primary';
