...
- Result: passed — 2 test files, 31 tests; Vitest duration 838ms.
...
- Scope: deployment classification, per-lane concurrency, exact-SHA CircleCI gates, exact-SHA Staging and Production expand evidence, immutable migration workflow identity, and CircleCI test-result collection.
